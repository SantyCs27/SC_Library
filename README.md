...
- In your project folder, create a `Plugins` folder `C:/UnrealProjects/MyProject/Plugins`
- Place the `SC_Library` folder in your Unreal Engine project's `Plugins` directory.
- Open your project in your IDE and build the project.
- If everything built successfully, you can keep the plugin local to your project. Or you can move it into the engine `Plugins` folder. 
    * `%PROJECT_DIR%/Plugins`
